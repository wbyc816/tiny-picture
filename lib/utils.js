...
exports.createImgList=function(list){
  return list.filter(name=>/\.(png|jpg|jpeg)$/i.test(name))
...
exports.report=function(temp){
  ...
  console.log(chalk.blue('Total compressed pictures: '+chalk.red(count)+' , saved: '+chalk.red('-'+parseInt((totalFrom-totalTo)/totalFrom*100)+'%')))
}
